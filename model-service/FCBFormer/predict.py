...
def build(args):
    ...
    root = os.path.dirname(args.test_img)
    img_path =  args.test_img + "/images/*"
    ...
    return device, model, target_paths
...
def get_args():
    ...
    parser.add_argument("--test-img", type=str, required=True, help="path to img")
